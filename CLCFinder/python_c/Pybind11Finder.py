...
class Pybind11Finder():
                    ...
                    with (open(file_path, 'r', encoding='ISO-8859-1',errors='ignore') as f):
                        ...
                        for i, line in enumerate(lines):
                            ...
                            if re.search(pattern, line.strip()):
                                ...
                                self.res_c_files.append(file_name)
                                break
    ...
    def find_pybind11(self, module_name):
                ...
                if file.endswith('.py'):
                    ...
                    with (open(file_path, 'r', encoding='ISO-8859-1',errors='ignore') as f):
                        ...
                        for i, line in enumerate(lines):
                            ...
                            if self.re_match(pattern_module, line):
                                self.res_python.append((file_path, i + 1, line))
                                import_flag = True

                            if self.re_match(pattern_module2, line):
                                self.res_python.append((file_path, i + 1, line))
                                import_flag = True
    ...
    def find_main(self):
        ...
        for c_file in self.res_c_files:
            self.find_pybind11(c_file)
...
if __name__ == '__main__':
    ...
    #     print('=================  pf.res_python  ===============================================')
    #     print(f'     pf.res_python的长度为{len(pf.res_python)}')
    #     for r in pf.res_python:
    #         print(r)
