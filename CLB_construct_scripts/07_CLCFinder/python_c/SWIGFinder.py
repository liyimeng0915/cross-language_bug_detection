...
class SWIGFinder():
                    ...
                    with (open(file_path, 'r', encoding='ISO-8859-1',errors='ignore') as f):
                        ...
                        for i, line in enumerate(lines):
                            ...
                            if match:
                                ...
                                name = match.group(1)
                                # print("Matched module name:", name)
                                # print(line)
    ...
    def find_SWIG(self, module_name):
    ...
    def find_main(self):
        ...
        self.module_name = myutils.list_deduplicated(self.module_name)
...
if __name__ == '__main__':
    ...
    #     # print(f'{p}=== res_python  ========')
    #     # print(f'     pf.res_python的长度为{len(sf.res_python)}')
    #     # for r in sf.res_python:
    #     #     print(r)
    #     # print(f'{p} === c_files ====')
    #     # for c in sf.c_files:
    #     #     print(c)
    #     # print(f'{p} ===  module_name ====')
    #     # for m in sf.module_name:
    #     #     print(m)
